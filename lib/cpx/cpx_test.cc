...
TEST(CpxTest, TwiceAlternating) {
  ...
  EXPECT_EQ(0, Create(&threads[0], &test_run_func, "2", 2, DefaultThreadConfig(stack0, 1024)));
  EXPECT_EQ(0, Create(&threads[1], &test_run_func, "22", 3, DefaultThreadConfig(stack1, 1024)));
