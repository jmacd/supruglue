...
// TODO: The once-DATA_SECTION below was incorrect. It causes the
// compiler to place this data in the text section, probably because
// it is page zero and there is not a linker command entry for the
